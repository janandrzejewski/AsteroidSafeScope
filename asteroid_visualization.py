...
app.layout = html.Div([
    ...
    dash_table.DataTable([], [{"name": i, "id": i} for i in asteroid_table_headers], id='tbl')  # Initialize with an empty table
])

@app.callback([Output('tbl', 'data'), Output('output-state', 'children')],
